...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://rainnn-w.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.rainnn.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Rainnn, 计算机, 笔记，学习经验', // 网站关键词 英文逗号隔开
